...
public class MainActivity extends AppCompatActivity {
    ...
    String[] fromLanguages={"From","English","Afrikaans","Arabic","Belarusian","Bengali","Catalan","Czech","Welsh","Hindi","Urdu","Tamil","Telugu"};
    String[] toLanguages={"To","English","Afrikaans","Arabic","Belarusian","Bengali","Catalan","Czech","Welsh","Hindi","Urdu","Tamil","Telugu"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        camIV.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                p.putExtra("FromLanguage",fromLanguageCode);
                p.putExtra("ToLanguage",toLanguageCode);
                startActivity(p);
            }
        });
